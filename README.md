...
print(xts.date_range(date(2023, 1, 1), date(2023, 1, 10), eager=True))
```
it means installation all worked correctly!

Read the [documentation](https://marcogorelli.github.io/polars-xts-docs/) for a little tutorial and API reference.
...
Read the [documentation](https://marcogorelli.github.io/polars-xts-docs/) for more examples!
